...
-- buffer navigation
vim.keymap.set("n", "_", "<cmd>bprevious<CR>", { desc = "Previous buffer" })
...
-- telescope (ENABLED for fuzzy file search)
-- Note: These keybindings are set up in the telescope plugin configuration
